...
<div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
    ...
    <a href="{{ route('admin.actividades.index') }}" class="btn btn-outline-secondary btn-sm rounded-pill font-weight-bold">
        <i class="fas fa-arrow-left mr-1"></i> Volver al listado
    </a>
</div>

<div class="card card-outline card-warning shadow-sm rounded-lg" data-aos="fade-up">
    <form action="{{ route('admin.actividades.update', $activity) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                        ...
                        <div class="col-md-3 col-6 mb-3">
                            <div class="card h-100 shadow-sm border">
                                ...
                                <div class="card-body p-2 text-center bg-light">
                                    <form action="{{ route('admin.actividades.evidences.destroy', $evidence) }}" method="POST" onsubmit="return confirm('¿Eliminar esta foto?')">
                                        @csrf
                                        @method('DELETE')
