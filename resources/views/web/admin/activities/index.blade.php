...
<div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
    ...
    <a href="{{ route('admin.activities.create') }}" class="btn btn-success btn-sm rounded-pill font-weight-bold shadow-sm">
            ...
            <tbody>
                @forelse($activities as $activity)
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ route('admin.activities.edit', $activity) }}" class="btn btn-sm btn-outline-warning rounded-circle" title="Editar"><i class="fas fa-edit"></i></a>
                            <form action="{{ route('admin.activities.destroy', $activity) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Confirma la eliminación permanente de esta actividad?')">
                                @csrf
                                @method('DELETE')
