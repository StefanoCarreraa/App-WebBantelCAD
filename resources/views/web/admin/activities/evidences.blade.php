...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.activities.index') }}" class="btn btn-secondary">Volver</a>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.activities.evidences.store', $activity) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
